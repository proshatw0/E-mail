Приложение взято с другой облачной системы, и разрабатывалось там мной, поэтмоу не смотрите на пустующие комиты. По тз необходимо было использовать платформу gitflic
